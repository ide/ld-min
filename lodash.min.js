 ...
 * Build: `lodash modern strict exports="node" -o lodash.min.js -p`
 */
...
!zt||zt.global!==zt&&zt.window!==zt&&zt.self!==zt||($t=zt);var zt=Ft&&Ft.exports===Bt&&Bt,Dt=m();Bt&&Ft&&zt&&((Ft.exports=Dt)._=Dt)}).call(this);